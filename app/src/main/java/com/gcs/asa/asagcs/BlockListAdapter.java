...
public class BlockListAdapter extends ArrayAdapter<BlockModel> {
  ...
  public BlockListAdapter(Context context, ArrayList<BlockModel> BlockModelArrayList) {
    ...
    super(context, R.layout.fragment_ac_block, BlockModelArrayList);
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    View rowView = null;
    rowView = inflater.inflate(R.layout.fragment_ac_block, parent, false);
    ...
    // 6. If item is clicked show clicked item template
      if (position == ClickedInd) {
          //Inflate fragment_bl_clicked template
          rowView = inflater.inflate(R.layout.fragment_bl_clicked, parent, false);
